                    ...
                    bcrypt.genSalt(10, (err, salt) => {
                        bcrypt.hash(password, salt, (err, hash) => {
                            ...
                            user.save().then((user) => {
                                ...
                                req.flash('info', 
                                'Registration successful, an Email as been sent to you please confirm to be able to login if not please contact the developer on tundeusman0@gmail.com to add your email to his Recipients');
